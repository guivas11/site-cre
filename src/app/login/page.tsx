      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-8 px-4 pb-24 pt-6 md:gap-10 md:px-6 md:pt-12">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="font-display text-4xl tracking-[0.12em]">Entrar no blog</h1>
          </div>
          <a
        ...
        <section className="glass mx-auto w-full max-w-lg rounded-2xl p-4 sm:rounded-3xl sm:p-8">
          ...
          <div className="mt-6 flex flex-col gap-2 border-t border-white/10 pt-5 text-xs uppercase tracking-[0.25em] text-zinc-400 sm:flex-row sm:items-center sm:justify-between">
